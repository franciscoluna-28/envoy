              ...
              <TableBody>
                {isLoadingMigrations ? (
                  ...
                  <TableRow>
                    <TableCell
                      colSpan={3}
                      className="py-12 text-center text-[11px] text-stone-400 font-medium uppercase tracking-widest"
                    >
                      Initial node state: No migrations found
                    </TableCell>
                  </TableRow>
                ) : (
                  migrations?.map((m) => (
                    <>
                      ...
                      >
                        <TableCell className="py-5 pl-6">
                          <div className="flex items-center gap-2">
                            <div
                              className={`font-bold text-sm tracking-tight ${m.status === "failed" ? "text-red-900" : "text-stone-900"}`}
                            >
                              {m.name}
                            </div>
                            {m.status === "failed" && (
